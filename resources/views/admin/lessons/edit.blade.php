                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.lessons.update', $lesson->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="slug" value="{{ $lesson->slug }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="path_id" id="" class="form-control">
                                    @foreach($paths as $path)
                                        <option value="{{ $path->id }}" {{ $lesson->path_id == $path->id ? 'selected' : '' }}>{{ $path->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="section_id" id="" class="form-control">
                                    @foreach($sections as $section)
                                        <option value="{{ $section->id }}" {{ $lesson->path_id == $section->id ? 'selected' : '' }}>{{ $section->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <br>
